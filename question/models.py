...
class Question(models.Model):
    ...
    question_file = models.FileField("题目文件", null=True, blank=True)
    ...
    answer_file = models.FileField("问题答案文件", null=True, blank=True)
    explain = models.TextField("答案解析", blank=True, null=True, default="无")
    explain_file = models.FileField("答案解析文件", null=True, blank=True)
