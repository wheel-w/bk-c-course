<template>
    <div class="create_question">
        ...
        <bk-dialog v-model="editQuestion.visable" width="1200" :draggable="false" :show-footer="false">
            <component v-if="editQuestion.visable" :is="Dict[editQuestion.Question.types]" :info="editQuestion.Question" @updateQuestion="updateQuestion" :editable="true"></component>
        </bk-dialog>
        <div class="questions">
